...
def get_all_gene_htseq_files(wildcards):
    #print(wildcards)
    run_ids = samples["sample_name"].tolist()
    out = []
    for r in run_ids:
        ...
        if config["single_end"]:
            wanted_input.extend(
                expand (
                        [
                            "results/trimmed/{sample}_trim.fastq.gz",
                            "results/fastqc_trim/{sample}_trim_fastqc.zip",
                ...
                wanted_input.extend(
                        expand (
                            [
                                ...
                                "results/fastqc_trim/{sample}_trim_{read}_fastqc.zip",
            ...
            wanted_input.extend(
                expand (
                        [
                            ...
                            "results/coverage/{sample}_CPM_low_quality.bw"
                        ],
                        sample = sample
                    )
                )
            ...
            wanted_input.extend(
                    expand (
                        [
                            ...
                            "results/coverage_no_bl/{sample}_fwd_no_bl_CPM_low_quality.bw",
                            "results/coverage_no_bl/{sample}_rev_no_bl_CPM_low_quality.bw",
                            "results/mapped/{sample}_htscounts.txt"
                        ],
                        sample = sample
                    )
